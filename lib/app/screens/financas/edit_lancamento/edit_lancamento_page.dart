...
class _EditLancamentoPagePageState extends State<EditLancamentoPage> {
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
      key: lancamentoViewModel.scaffoldMessengerKey,
      child: Scaffold(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: CustomDropDown(
                                ...
                                onTap: (tipo) {
                                  if (tipo == Tipo.ENTRADA.value) {
                                    lancamentoViewModel.tipo.value =
                                        Tipo.ENTRADA;
                                  } else {
                        ...
                        CustomDropDown(
                          itens: lancamentoViewModel.formasPagamento.value,
                          onTap: (forma) {
                            lancamentoViewModel.formaPagamentoCtrl.text = forma;
                          },
                          child: StyledFormField(
                            readOnly: true,
                            textEditingController:
                                lancamentoViewModel.formaPagamentoCtrl,
                          ...
                          children: [
                            TypeAheadFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  errorBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(
                                        color:
                                            CustomColors.error.withOpacity(.3),
                                        width: .5),
                                  ),
                              ...
                              onSuggestionSelected: (Contato value) {
                                ...
                                lancamentoViewModel.contatoCtrl.text =
                                    value.nome;
                              },
                                      ...
                                      CustomButton.secondary(
                                        ...
                                        onTap: () async {
                                          if (Responsive.isMobile(context)) {
                                            ...
                                            Contato? contato = await showDialog(
                                              context: context,
                                              builder: (context) {
                                                return Row(
                                                  children: [
                                            ...
                                            lancamentoViewModel.contato.value =
                                                contato;
                                            lancamentoViewModel.contatoCtrl
                                                .text = contato?.nome ?? '';
                                          }
                                        },
                                        icon: ImageIcon(
